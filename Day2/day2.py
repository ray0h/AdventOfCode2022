...
file = open("/Users/raymondoh/Documents/AdventOfCode2022/data/day2.txt", "r").readlines()

scores = [scoring[el.strip()] for el in file]

import functools
import operator
total_score = functools.reduce(operator.add, scores)
...
translated_file = [translated_plays[line.strip()] for line in file]
parttwo_scores = [scoring[line] for line in translated_file]
total_parttwo_score = functools.reduce(operator.add, parttwo_scores)

print(f"{total_parttwo_score = }")
