...
file = open("/Users/raymondoh/Documents/AdventOfCode2022/data/day1.txt", "r").readlines()
...
file_list = [strip_val(el) for el in file]
sums_arr = []
sum = 0
for el in file_list:
    if el != '':
...
sums_arr.sort()
top_three = sums_arr[-3:]

import functools
import operator
print(f"top three sum = {functools.reduce(operator.add, top_three)}")
